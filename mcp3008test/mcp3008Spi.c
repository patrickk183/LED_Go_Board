...
/**********************************************
 * Higher level function to get controller input
 * ********************************************/
 //Inspec wire hookup to determine the channel to control mapping
int getControllerInput(int channel) {

    static mcp3008Spi a2d("/dev/spidev0.0", SPI_MODE_0, 1000000, 8);
    int a2dVal = 0;
