...
static int do_move_comm(Gameinfo *gameinfo, char *command, int *passes, int force);
static int do_move(Gameinfo *gameinfo, char *command, int *passes, int force);
static int do_move2(Gameinfo *gameinfo, char *command, int *passes, int force);
...
do_play_ascii(Gameinfo *gameinfo)
{
  ...
  while (state == 1) {
    ...
    if (players == 1 && gameinfo->computer_player == gameinfo->to_move)
